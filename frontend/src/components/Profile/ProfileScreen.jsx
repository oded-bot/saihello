...
export default function ProfileScreen() {
  ...
  return (
    <div className="px-5 pt-8">
      ...
      {/* Wie SaiHello funktioniert – Neu aufrufen */}
      {localStorage.getItem('hideHowItWorks') === 'true' && (
        ...
        >
          <span>❓</span>
          Wie SaiHello funktioniert erneut anzeigen
        </button>
      )}
      ...
      <p className="text-center text-gray-300 dark:text-gray-600 text-xs mt-6 pb-4">SaiHello v2.0</p>
